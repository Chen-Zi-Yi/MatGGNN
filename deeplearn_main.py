...
def main():
    ...
    dst = os.path.join('jobs', config['Job']['job_name'])
    if not os.path.exists(dst):
        os.mkdir(dst)
    if os.path.exists(config['Job']['job_name']+'_setting.txt'):
        shutil.move(config['Job']['job_name']+'_setting.txt', dst)
    if os.path.exists(config['Job']['job_name']+'_train_outputs.csv'):
        shutil.move(config['Job']['job_name']+'_train_outputs.csv', dst)
    if os.path.exists(config['Job']['job_name']+'_test_outputs.csv'):
        shutil.move(config['Job']['job_name']+'_test_outputs.csv', dst)
    if os.path.exists(config['Job']['job_name']+'_val_outputs.csv'):
        shutil.move(config['Job']['job_name']+'_val_outputs.csv', dst)
    if os.path.exists(config['Job']['job_name']+'_errorvalues.csv'):
        shutil.move(config['Job']['job_name']+'_errorvalues.csv', dst)
    if os.path.exists(config['Job']['model_path']):
        shutil.move(config['Job']['model_path'], dst)
